...
public:
	...
	void IniDomain(int rank,Node2D & Node,int elem, int nodenumber, double* pos,double& Rho, double* U);
	void IniDomain(int rank,Node2D & Node,int elem, int nodenumber, double* pos,double& Rho, double* U,double & alpha);
